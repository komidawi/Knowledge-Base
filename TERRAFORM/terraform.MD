...
5. It's good to include unit in the name, e.g. `ram_size_gb`
...
2. The root module is the one where other modules and resources are instantiated
3. Modules let you group a set of resources and reuse them later
